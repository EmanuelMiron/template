              ...
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium transition-all duration-200 cursor-pointer ${
                  activeFilter === category.id
                    ...
                    : 'bg-muted text-muted-foreground hover:bg-muted/80 hover:scale-105 border border-border'
                }`}
              >
                {category.icon}
                {category.label}
            ...
            <Card key={project.id} className="group overflow-hidden hover:shadow-xl transition-all duration-300">
              ...
              <div className="relative aspect-video overflow-hidden bg-muted">
                ...
                <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity duration-200 flex items-center justify-center gap-4">
                  <button 
                    className="w-12 h-12 bg-background rounded-full flex items-center justify-center shadow-lg hover:bg-muted hover:scale-105 transition-all duration-200 cursor-pointer"
