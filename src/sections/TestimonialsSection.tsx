    ...
    <section className={`${sizeClasses[size]} bg-gray-50 ${className}`}>
      <div className="container mx-auto px-4">
              ...
              <Card key={index} variant="outline" className="group hover:shadow-lg transition-all duration-300">
                <CardContent className="p-6">
                  <div className="flex items-start space-x-4">
                    {showQuotes && (
                      <Quote className="w-6 h-6 text-blue-100 mt-1 group-hover:text-blue-200 transition-colors flex-shrink-0" />
                    )}
        ...
        <div className="text-center mt-16">
          ...
          <p className="text-gray-600">Based on {testimonials.length}+ customer reviews</p>
        </div>
      </div>
    </section>
  );
