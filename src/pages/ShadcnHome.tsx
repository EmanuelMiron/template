    ...
    <div className="min-h-screen p-8 bg-background text-foreground">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-8">
         ...
         <Collapsible>
            <CollapsibleTrigger variant="primary" size="lg">
              <h2 className="text-2xl font-semibold">Custom Combobox Component Examples</h2>
            </CollapsibleTrigger>
            <CollapsibleContent variant="outline" padding="lg">
              <div className="space-y-6">
                {/* Basic Combobox Examples */}
                <div>
                  <h4 className="font-semibold text-lg mb-4">Basic Combobox Examples</h4>
                  <div className="space-y-6">
                    <div>
                    ...
                    <div>
                      <h5 className="font-medium mb-2">Combobox with Different Sizes</h5>
                      <div className="space-y-4">
                        <div>
                          <p className="text-sm text-muted-foreground mb-2">Small Size:</p>
                          <CustomCombobox
                ...
                <div>
                  ...
                  <div className="space-y-6">
                    <div>
                      <h5 className="font-medium mb-2">Combobox with Label and Helper Text</h5>
                      <CustomCombobox
                        options={[
                    ...
                    <div>
                      <h5 className="font-medium mb-2">Combobox with Error State</h5>
                      <CustomCombobox
                        options={[
                    ...
                    <div>
                      <h5 className="font-medium mb-2">Combobox with Custom Messages</h5>
                      <CustomCombobox
                        options={[
                ...
                <div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      <h5 className="font-medium mb-2">Combobox with Many Options</h5>
                      <CustomCombobox
